    ...
    if(args.mode == 'test'):
        if(args.data is None):
            ...
            if(args.patch_size == None):
                ...
                patch_size = tuple(args.patch_size)
            unet = Predictor3DUnet(args.save_name, patch_size, args.gpus, loss_function=args.loss_function, use_validation=args.use_validation, part_to_test_on=part_to_test_on, location_previous_training_and_validation_indices=location_previous_training_and_validation_indices)
            ...
            if(args.patch_size == None):
                ...
                patch_size = tuple(args.patch_size)
            predictor = Predictor3DCNN(args.save_name, args.gpus, loss_function=args.loss_function, input_size=patch_size, use_validation=args.use_validation, part_to_test_on=part_to_test_on, location_previous_training_and_validation_indices=location_previous_training_and_validation_indices)
