...
def train_without_crossvalidation(neural_net, d, l, n_epochs, save_name, batch_size=16, use_validation=False, training_with_slurm=False, validation_data_location=None, validation_labels_location=None):
