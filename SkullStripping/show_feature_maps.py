...
def main():
    ...
    model, paralell_model = Build3DUnet.build_3DUnet((cube_size, cube_size, cube_size, 1), 1, 'dcl')
    model.load_weights("C:\\Users\\oyste\\Documents\\Visual Studio 2015\\Projects\\SkullStripping\\BrainSegmentationStOlavs\\Experiments\\UnetDifferentLossFunction\\UnetDifferentLossFunction.h5")
